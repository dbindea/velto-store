        ...
        <div class="bg-slate-800/50 backdrop-blur rounded-2xl p-8 border border-slate-700">
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-4 p-4 bg-slate-700/50 rounded-xl">
              <div class="w-3 h-3 rounded-full" [class.bg-green-500]="status.firebaseInitialized" [class.bg-red-500]="!status.firebaseInitialized"></div>
            ...
            <div class="flex items-center gap-4 p-4 bg-slate-700/50 rounded-xl">
              <div class="w-3 h-3 rounded-full" [class.bg-green-500]="status.firestoreConfigured" [class.bg-red-500]="!status.firestoreConfigured"></div>
              <span class="text-lg">Ready for Firestore</span>
            </div>

            <div class="flex items-center gap-4 p-4 bg-slate-700/50 rounded-xl">
              <div class="w-3 h-3 rounded-full" [class.bg-green-500]="status.authConfigured" [class.bg-red-500]="!status.authConfigured"></div>
              <span class="text-lg">Auth preparado</span>
            </div>

            <div class="flex items-center gap-4 p-4 bg-slate-700/50 rounded-xl">
              <div class="w-3 h-3 rounded-full" [class.bg-green-500]="status.storageConfigured" [class.bg-red-500]="!status.storageConfigured"></div>
